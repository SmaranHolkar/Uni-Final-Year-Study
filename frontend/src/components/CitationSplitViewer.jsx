      ...
      >
        ...
        {isLoading ? (
          ...
          <div className="h-64 flex flex-col items-center justify-center text-center px-4 space-y-2">
            ...
            <p className="text-xs font-semibold text-slate-200">No matching paragraphs found</p>
      ...
      <div className="p-3 border-t border-slate-800 bg-[#080d17]/95 flex items-center justify-between gap-2 flex-shrink-0">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          ...
          <button
            ...
            className="px-2.5 py-1.5 rounded-lg bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-300 border border-emerald-500/30 text-xs font-semibold flex items-center gap-1 transition-all"
